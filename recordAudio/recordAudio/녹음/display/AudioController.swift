...
//        }
        ...
        do {
            ...
            do {
                if #available(iOS 10.0, *) {
                    ...
                    try sessionInstance.setCategory(.playAndRecord, options: .allowBluetooth)
                }
            } catch let error as NSError {
            ...
            do {
                ...
                try sessionInstance.setPreferredSampleRate(1000)
            } catch let error as NSError {
    ...
    private func setupIOUnit() {
        do {
            ...
            var ioFormat = CAStreamBasicDescription(sampleRate: 1000, numChannels: 1, pcmf: .float32, isInterleaved: false)
